...
var Message = function () {
  ...
  _createClass(Message, [{
    ...
    value: function createPost(post) {
      ...
      var modelPost = '<div class="header-h1">\n                        <h1>' + this.login + '</h1>\n                      </div>\n                       <h3>' + this.text + '</h3>\n                        ';
...
var Page = function Page() {
  ...
  var createImg = document.querySelector('.createImg');
...
var Activator = function Activator(event) {
  event.preventDefault();
  ...
  var time = hours + ':' + min;
  var formGener = event.target.parentElement;
  var comment = [];
